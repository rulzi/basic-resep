<x-app-layout>
    ...
    @endif
    <form class="form-horizontal" action="{{ route('ingredient.update', $ingredient->id) }}" method="POST" enctype="multipart/form-data">
        <x-card-navbar>
            <x-slot name="header">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <x-input id="name" class="{{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" :value="old('name', $ingredient->name)"/>
                    @if ($errors->has('name'))
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control" name="description">{{ old('description', $ingredient->description) }}</textarea>
