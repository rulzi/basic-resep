...
<x-app-layout>
    ...
    <form class="form-horizontal" action="{{ route('recipe.store') }}" method="POST" enctype="multipart/form-data">
        <x-card-navbar>
            <x-slot name="header">
                ...
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-two-profile-tab" href="{{ route('recipe.create') }}">{{ __('Add') }}</a>
                </li>
                <li class="nav-item">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="category_id" class="form-control select2category {{ $errors->has('category_id') ? 'is-invalid' : '' }}">
                    </select>
